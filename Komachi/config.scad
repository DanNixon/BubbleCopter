...
RUDDER_MATERIAL_THICKNESS = 3;
HALF_RUDDER_MATERIAL_THICKNESS = RUDDER_MATERIAL_THICKNESS / 2;

/* General */
CORNER = 1;
HALF_CORNER = CORNER / 2;
SPACER_TAB_WIDTH_FACTOR = 0.35;
LOWER_SKIRT_MOUNT_SPACING = 20;

/* Base plate */
BASE_DIMENSIONS = [200, 300];
...
RUDDER_MOUNT_TAB_LENGTH = MATERIAL_THICKNESS + 5;
...
/* Skirt tabs */
SKIRT_TABS = true;
SKIRT_TABS_PADDING = 30;
SKIRT_TABS_OFFSET = [0, 10];
SKIRT_TABS_WIDTH = 12;
SKIRT_TABS_MOUNT_WIDTH = 20;
