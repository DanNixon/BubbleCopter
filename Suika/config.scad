...
/* FPV camera */
FPV_CAMERA_ANGLE = 30;
FPV_CAMERA_POSITON = [0, 2, 15];

/* Camera mount */
CAMERA_BRACKET_SPACING = 22;
CAMERA_BRACKET_LENGTH = PLATE_DIMENSIONS[1] * 0.9;
CAMERA_BRACKET_BASE_HEIGHT = 8;
CAMERA_BRACKET_LOW_CAM_POS = -3;
CAMERA_BRACKET_HIGH_CAM_POS = 5;
CAMERA_BRACKET_TAB_WIDTH = 5;
CAMERA_BRACKET_TAB_OFFSET = CAMERA_BRACKET_LENGTH * 0.325;
CAMERA_BRACKET_PANEL_HEIGHT = 10;
CAMERA_BRACKET_PANEL_OFFSET = 2;
CAMERA_BRACKET_PANEL_TAB_WIDTH = CAMERA_BRACKET_PANEL_HEIGHT * 0.6;
